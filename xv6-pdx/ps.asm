...
printint(int fd, int xx, int base, int sgn)
{
 ...
 574:	0f b6 92 dc 08 00 00 	movzbl 0x8dc(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 6c5:	75 28                	jne    6ef <printf+0x12e>
          s = "(null)";
 6c7:	be d4 08 00 00       	mov    $0x8d4,%esi
...
free(void *ap)
{
 ...
 73e:	a1 e4 0b 00 00       	mov    0xbe4,%eax
...
morecore(uint nu)
{
 ...
 7d9:	e8 50 ff ff ff       	call   72e <free>
  return freep;
 7de:	a1 e4 0b 00 00       	mov    0xbe4,%eax
...
malloc(uint nbytes)
{
 ...
 806:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 809:	8b 0d e4 0b 00 00    	mov    0xbe4,%ecx
 ...
 815:	eb 4b                	jmp    862 <malloc+0x70>
    base.s.ptr = freep = prevp = &base;
 817:	c7 05 e4 0b 00 00 e8 	movl   $0xbe8,0xbe4
 81e:	0b 00 00 
 821:	c7 05 e8 0b 00 00 e8 	movl   $0xbe8,0xbe8
 828:	0b 00 00 
    base.s.size = 0;
 82b:	c7 05 ec 0b 00 00 00 	movl   $0x0,0xbec
 832:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 835:	b9 e8 0b 00 00       	mov    $0xbe8,%ecx
 ...
 846:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 849:	89 0d e4 0b 00 00    	mov    %ecx,0xbe4
      return (void*)(p + 1);
 ...
 867:	73 d3                	jae    83c <malloc+0x4a>
    if(p == freep)
 869:	39 05 e4 0b 00 00    	cmp    %eax,0xbe4
